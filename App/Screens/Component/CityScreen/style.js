...
export default 
{
    ...
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'),
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('20%'), alignItems : 'center' , width : 60 
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), fontFamily : 'ge-ss-two-medium' ,
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('10%'), alignItems : 'center' , width : 60 
    },
    city_no: Platform.OS == "ios" ?
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), 
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('15%'),
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'),
    ...
    city_add : Platform.OS == "ios" ? 
    {
        ...
        fontSize :  hp('2.5%') , height : 25 , alignItems : 'center' , width : 140  ,marginLeft: wp('5%')
    }:
    {
