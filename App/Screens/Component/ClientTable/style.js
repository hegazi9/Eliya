...
export default
    {
        ...
        {
            flexDirection: 'row', marginLeft: wp('2%'), marginTop: hp('5%')
        ...
        row: Platform.OS == "ios" ?
        {
            flexDirection: 'row', marginLeft: wp('40%'), marginTop: hp('6%'), marginLeft: wp('4%'),
            zIndex : 1 , width : 100
...
,
    ...
    {
        color : '#14789d',fontSize :  hp('1.4%'), textAlign : 'right' , marginLeft : wp('4%') ,
...
row4: Platform.OS == "ios"?
{
    flexDirection: 'row', marginLeft: wp('70%'), marginTop: hp('-3%') , 
    width : 100 , zIndex :1 

}:
        {
            flexDirection: 'row', marginLeft: wp('70%'), marginTop: hp('-4.17%')
        },
