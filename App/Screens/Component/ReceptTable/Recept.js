...
class FilterTable extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      arr: [], role_name: '',
      contractNo: 0,Checker : false ,  refresh:false, 
      name: '',
    }
    this.offset = 0;
    this.offset1 = 0;
  ...
  set_search (text)
   {
    ...
    axios.get(`http://188.225.184.107:7071/api/Customers/Filtered?offset=${this.offset1}&limit=10&CustomerName=${text}`,
    {  
      headers: 
      { 
    ...
    _get_Clients ()
    {
      ...
      axios.get(`http://188.225.184.107:7071/api/Customers/Filtered/?offset=${this.offset}&limit=20`,
      {  
       headers: 
       { 
          'Content-Type': 'application/json',
      ...
      .then(responseJson => {
        ...
        this.setState({
          ...
          arr :  [...this.state.serverData, ...responseJson.data.data],
