...
export default 
{
    ...
    model  : Platform.OS == "ios" ?
    {
        ...
        margin : hp('1.5%'), borderRadius : hp('2%')   , height : hp('50%')  ,marginLeft : wp('5%') ,
    ...
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), 
        fontSize :  hp('2%') , height : 35 , marginLeft : wp('4%'), alignItems : 'center' , width : 110 
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), fontFamily : 'ge-ss-two-medium' ,
        fontSize :  hp('2%') , height : 35 , marginLeft : wp('4%'), alignItems : 'center' , width : 110 
    ...
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%') ,
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('18%'),
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), 
        fontSize :  hp('1.5%') , height : 25 , marginLeft : wp('18%'),
    },
    ...
    }:
    {
        ...
        fontSize :  hp('2%') , height : 25 , alignItems : 'center' , width : 200  ,marginLeft: wp('-15%')   
    },
