...
export default 
{
    ...
    {
        alignSelf : "center" , color : 'white',  marginLeft : wp('25%'),marginTop : hp('1%'),
    ...
    model  : Platform.OS == "ios" ?
    {
        ...
        margin : hp('1.5%'), borderRadius : hp('2%')   , height : hp('35%')  ,marginLeft : wp('5%') ,
    ...
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), 
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('17%'), alignItems : 'center' , width : 60 
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), fontFamily : 'ge-ss-two-medium' ,
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('17%'), alignItems : 'center' , width : 60 
    ...
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'),
        fontSize :  hp('1.5%') , height : 25 , marginLeft : wp('16%'),
    }:
    {
        alignSelf : "center" , color : '#0b485b',  marginTop : hp('.5%'), fontFamily : 'ge-ss-two-medium' ,
        fontSize :  hp('2%') , height : 25 , marginLeft : wp('16%'),
    },
    ...
    input_add: Platform.OS == "ios" ?
    {
      ...
      , borderRadius : hp('2%') , marginTop : hp('1.5%') , height : hp('7%') , marginLeft: wp('2%') 
      , fontSize : hp('2%') , width : wp('85%') , color : '#0b485b' , textAlign : 'center'
    }:
    {  
    ...
    city_add : Platform.OS == "ios" ?
    {
        ...
        fontSize :  hp('2.5%') , height : 25 , alignItems : 'center' , width : 200  ,marginLeft: wp('3%') , 
        marginBottom : hp('3%')  
    }:
    {
    ...
    {
        padding : hp('.5%') , borderColor : 'white' , width : wp('90%') , backgroundColor : '#d1d3d4' , 
        margin : hp('1.5%'), borderRadius : hp('2%')   , height : hp('65%')  ,marginLeft : wp('5%') ,
        shadowColor: '#000', marginTop : hp('9%') ,
        shadowOffset: {
          width: 0,
          height: 2
        },
    ...
    {
        padding : hp('.5%') , borderColor : 'white' , width : wp('90%') , backgroundColor : '#d1d3d4' , 
        margin : hp('1.5%'), borderRadius : hp('2%')   , height : hp('55%')  ,marginLeft : wp('5%') ,
        shadowColor: '#000', marginTop : hp('9%') ,fontFamily : 'ge-ss-two-medium',
        shadowOffset: {
          width: 0,
          height: 2
        },
    ...
    row_add : Platform.OS == "ios" ?
    {
        flexDirection : 'row'  , marginTop : wp('30%') , marginLeft :  wp('13%') ,
    }:
    {
    ...
    {
        marginLeft : hp('1%') , height: hp('6%'), width: wp('90%') ,
        marginTop : hp('1%') , marginBottom : hp('5%')
